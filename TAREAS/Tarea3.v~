...
input B;    //: /sn:0 {0}(170,286)(199,286)(199,258)(238,258){1}
//: {2}(242,258)(275,258){3}
//: {4}(240,260)(240,368)(380,368){5}
input A;    //: /sn:0 {0}(170,253)(221,253){1}
//: {2}(225,253)(275,253){3}
//: {4}(223,255)(223,363)(380,363){5}
...
//: enddecls
  ...
  and g9 (.I0(A), .I1(B), .Z(w14));   //: @(391,366) /sn:0 /delay:" 5" /w:[ 5 5 0 ]
  or g7 (.I0(w11), .I1(w14), .Z(Co));   //: @(476,346) /sn:0 /delay:" 6" /w:[ 1 1 0 ]
  //: joint g12 (B) @(240, 258) /w:[ 2 -1 1 4 ]
  //: joint g11 (A) @(223, 253) /w:[ 2 -1 1 4 ]
...
//: enddecls
  ...
  //: switch g1 (w1) @(92,175) /sn:0 /w:[ 0 ] /st:1
  led g5 (.I(w6));   //: @(444,259) /sn:0 /R:3 /w:[ 1 ] /type:0
  //: switch g0 (w0) @(92,113) /sn:0 /w:[ 0 ] /st:1
