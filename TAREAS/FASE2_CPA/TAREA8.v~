...
wire [15:0] w6;    //: /sn:0 /dp:1 {0}(675,227)(644,227)(644,257){1}
wire [15:0] w4;    //: /sn:0 /dp:1 {0}(575,228)(605,228)(605,257){1}
wire w0;    //: /sn:0 {0}(543,305)(574,305){1}
wire w1;    //: /sn:0 {0}(716,305)(679,305){1}
wire [15:0] w5;    //: /sn:0 {0}(627,377)(627,351){1}
//: enddecls

  //: switch g4 (w0) @(526,305) /sn:0 /w:[ 0 ] /st:1
  //: dip g3 (w6) @(713,227) /sn:0 /R:3 /w:[ 0 ] /st:0
  //: dip g2 (w4) @(537,228) /sn:0 /R:1 /w:[ 0 ] /st:65535
  led g1 (.I(w5));   //: @(627,384) /sn:0 /R:2 /w:[ 0 ] /type:3
  led g5 (.I(w1));   //: @(723,305) /sn:0 /R:3 /w:[ 0 ] /type:2
  CPA_16b g0 (.B(w6), .A(w4), .Cin(w0), .S(w5), .Cout(w1));   //: @(575, 258) /sz:(103, 92) /sn:0 /p:[ Ti0>1 Ti1>1 Li0>1 Bo0<1 Ro0<1 ]
